...
function peg$parse(input, options) {
  ...
  var peg$e14 = peg$literalExpectation("contains", false);
  var peg$e15 = peg$literalExpectation("len", false);
  ...
  var peg$f4 = function(op) { return op; };
  ...
  var peg$f24 = function(chars) { return { kind: 'literal', valueKind: 'string', value: chars }; };
  var peg$f25 = function(chars) { return { kind: 'literal', valueKind: 'string', value: chars }; };
  var peg$f26 = function(path) { return { kind: 'identifier', path: path }; };
  var peg$f27 = function(path) { return { kind: 'identifier', path: path }; };
  var peg$f28 = function(path) { return { kind: 'identifier', path: path }; };
  ...
  function peg$parseIdentifierExpr() {
    ...
    s0 = peg$parseDollarIdent();
    if (s0 === peg$FAILED) {
      s0 = peg$parseHashIdent();
      if (s0 === peg$FAILED) {
